...
public class LevelManager : MonoBehaviour
{
    ...
    public List<Piece> logs = new List<Piece>();
    public List<Piece> humans = new List<Piece>();
    ...
    public Piece GetPiece(PieceType pt, int visualIndex)
    {
        ...
        if(p==null)
        {
            ...
            else if(pt == PieceType.log)
            {
                go = logs[visualIndex].gameObject;
            }
            else if(pt == PieceType.human)
            {
                go = humans[visualIndex].gameObject;
            }
            go = Instantiate(go);
